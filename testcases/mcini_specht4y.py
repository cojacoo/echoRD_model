...
inimf='moist_specht.dat'  #initial_moisture
...
macimg='specht_macimages.dat'         #macropore image list file
...
matrixbf='matrix_specht.dat'       #matrix base file
matrixdeffi='matrixdefspecht.dat' #matrix definition file
